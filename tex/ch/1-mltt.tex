...
\index{types!Marti-L\"{o}f theory}
...
\index{types!dependent!$ \Pi $ (product)}
...
\item $ \Pi $-equality:
  ...
  $.
\end{itemize}
\index{types!dependent!$ \Pi $ (product)!formation}
\index{types!dependent!$ \Pi $ (product)!equality}
...
\]
\index{types!dependent!$ \Pi $ (product)!renaming}
...
\]
\index{types!dependent!$ \Pi $ (product)!$ \lambda $-abstraction}
...
\]
\index{types!dependent!$ \Pi $ (product)!$ \lambda $-equality}
...
\]
\index{types!dependent!$ \Pi $ (product)!function evaluation}
...
\end{itemize}
\index{types!dependent!$ \Pi $ (product)!$ \beta $-reduction}
\index{types!dependent!$ \Pi $ (product)!$ \eta $-conversion}
...
\index{types!dependent!$ \to $ (function)}
...
$.
\end{itemize}
\index{types!dependent!$ \to $ (function)!formation}
\index{types!dependent!$ \to $ (function)!$ \lambda $-abstraction}
\index{types!dependent!$ \to $ (function)!$ \lambda $-evaluation}
\index{types!dependent!$ \to $ (function)!$ \beta $-reduction}
\index{types!dependent!$ \to $ (function)!$ \eta $-conversion}
...
\index{types!dependent!$ \to $ (function)!composition}
